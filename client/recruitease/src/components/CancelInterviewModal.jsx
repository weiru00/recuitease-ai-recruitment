...
const CancelInterviewModal = ({ onCloseModal, onConfirm }) => {
  return (
    <div
        ...
        <div className="mt-3 text-center mb-3">
          ...
          <div className="mt-2 px-7 py-3">
            <p className="text-sm text-gray-500">
              Are you sure you want to cancel this interview? This action will
              trigger an automated email to the applicant.
            </p>
          </div>
        </div>
